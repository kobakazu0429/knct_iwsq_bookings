...
import type { FormatterFn } from "@devexpress/dx-react-scheduler";
import type { WeekViewProps } from "@devexpress/dx-react-scheduler-material-ui";
...
const formatTimeScaleDate: FormatterFn = (date) => moment(date).format("HH:mm");

const TimeScaleLabel: WeekViewProps["timeScaleLabelComponent"] = (props) => (
...
const Calendar = () => {
  return (
    // @ts-expect-error
    <Scheduler data={appointments} height={660} locale="ja-JP">
      <ViewState defaultCurrentDate={currentDate} />
      <Toolbar />
      <ViewSwitcher />
      <WeekView timeScaleLabelComponent={TimeScaleLabel} />
      <MonthView />
      <DateNavigator />
      <TodayButton />
      <Appointments />
    ...
    <section>
      ...
      <div className="relative mx-auto max-w-screen-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="col-span-1 p-8 pl-4">
